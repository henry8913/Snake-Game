...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Sync with global direction variables
    ...
    function handleKeyPress(e) {
        ...
        if ([37, 38, 39, 40].includes(e.keyCode)) {
            ...
            switch (e.keyCode) {
                case 37: // Left arrow
                    if (window.gameDirection !== 'right') window.gameNextDirection = 'left';
                    break;
                case 38: // Up arrow
                    if (window.gameDirection !== 'down') window.gameNextDirection = 'up';
                    break;
                case 39: // Right arrow
                    if (window.gameDirection !== 'left') window.gameNextDirection = 'right';
                    break;
                case 40: // Down arrow
                    if (window.gameDirection !== 'up') window.gameNextDirection = 'down';
                    break;
            }
        }
    }
    ...
    function drawPowerUpIndicator() {
        ...
        const x = (canvas.width - indicatorWidth) / 2;  // Centra orizzontalmente
